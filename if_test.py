...
#2. 이중선택(이중 조건문) :짝수면- 짝수입니다 홀수면 -홀수입니다
if num %2 ==0:
    print("짝수입니다")
else:
    print("홀수입니다")
...
#예제3 점수입력 받아 80점 이상이면 합격 그렇지 않으면 불합격 출력
...
#다중 선택문 if~elif~else
# 나이 8미만 유아 8살이상 19살 이하 학생 그외 는 성인
age = int(input("나이 입력: "))
